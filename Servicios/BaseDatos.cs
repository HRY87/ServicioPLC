...
namespace PLCServicio.Servicios
{
    public class BaseDatos : IDisposable
    {
        ...
        public BaseDatos(ConfiguracionDatabases configuracion, Logger logger)
        {
        ...
        private async Task EjecutarInsertAsync(LecturaPlc lectura, string connectionString, CancellationToken cancellationToken)
        {
            ...
            comando.Parameters.AddWithValue("@KgHoraActual", lectura.Produccion.KgHoraActual);
            comando.Parameters.AddWithValue("@EspesorActual", lectura.Produccion.EspesorActual);
            comando.Parameters.AddWithValue("@AnchoBrutoActual", lectura.Produccion.AnchoBrutoActual);
            comando.Parameters.AddWithValue("@MetrosPorMinActual", lectura.Produccion.MetrosPorMinActual);
            comando.Parameters.AddWithValue("@GramajeActual", lectura.Produccion.GramajeActual);
